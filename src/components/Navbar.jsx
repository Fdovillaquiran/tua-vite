...
const Navbar = () => {
  return (
    ...
    <ul className='flex w-full justify-between my-3'>
      <li><svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 mx-3 text-white" viewBox="0 0 20 20" fill="currentColor">
      ...
      <li><h1 className='text-white font-extrabold text-lg'>HERRAMIENTA ADMINISTRATIVA</h1></li>
      <li className='px-3'>
        <button className='bg-white p-2 text-orange-500 rounded-lg shadow-md hover:bg-orange-800 hover:text-white'>
          <Link to='/auth/login'>
            Iniciar Sesión
          </Link>
        </button>
